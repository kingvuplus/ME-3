...
cmd = "Mediasatc '%s' '%s' '%s'" % ('127.0.0.1',PortNumber,'/etc/init.d/restartEmu.sh &')
system(cmd)
#End
...
from MediaSat.SkinDeveloperSummary import SkinDeveloperSummary
...
#			dump(self.current_dialog)
	...
	def instantiateSummaryDialog(self, screen, **kwargs):
		self.pushSummary()
		if config.Mediasat.skindevelopermode.value:
