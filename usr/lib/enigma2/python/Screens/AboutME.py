...
class AboutMediaSat(Screen):

    def __init__(self, session):
        Screen.__init__(self, session)
        self['EnigmaVersion'] = StaticText('www.media-sat.net-ME-TEAM')
        self['ImageVersion'] = StaticText('<<<REDOUANE>>> coder')
        self['Team-ME'] = StaticText('<<<HOMER SIMPSON:>>>assistent coding')
        self['KernelVersion'] = StaticText('<<<TOYO>>> administrator of the forum')
        self['FPVersion'] = StaticText('<<<MAMBA65>>>skinner creator')
        self['CpuInfo'] = StaticText('<<<SANDRIJE>>>creator of graphics')
        self['TunerHeader'] = StaticText('assistants ME-TEAM:')
        self['hddA'] = StaticText('Serversat Youcef-el-arabi Popazerty betatesters Spark receivers')
...
class AboutME(Screen):
    ...
    def populate(self):
        self['lab1'] = StaticText(_('MediaSat Image'))
        self['lab2'] = StaticText(_('muzoss edition'))
        model = None
        AboutText = ''
        self['lab3'] = StaticText(_('Support at') + ' www.media-sat.net')
